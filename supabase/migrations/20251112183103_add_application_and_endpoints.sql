/*
  ...
  2. Crear tabla `api_endpoints`
     ...
     - `path` (text) - Ruta del endpoint
     - `method` (text) - Método HTTP
     - `description` (text) - Descripción del endpoint
...
-- Nota: Mantenemos endpoint_path y method por compatibilidad con datos existentes
-- En nuevas integraciones, se usarán los endpoint_id